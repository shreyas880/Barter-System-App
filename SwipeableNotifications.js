...
export default class SwipeableNotifications extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  updateMarkAsread = notification => {
    ...
    db.collection('AllNotifications').doc(notification.docId).get().then((doc) => {
        var data = doc.data();
  ...
  onSwipeValueChange = (swipeData) => {
    ...
    //console.log('Swipe Value is working')
